...
- **Why construction choices were made:** [`briefs/panel_construction_decisions.md`](../briefs/panel_construction_decisions.md).
- **Provenance** (source, URL, download date, MD5) for raw files: `raw/MANIFEST.csv`.

> **Reproducibility invariant.** Never edit files under `raw/`. Derived data (`processed/`, `panels/`) is
