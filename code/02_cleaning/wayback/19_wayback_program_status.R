...
#   briefs/panel/panel_construction_decisions.md N18/W7; 2018 is explicit NA, NOT LOCF-filled, unlike
...
#   operating status. Covers the 10 program groups already flagged downstream (facility spine,
#   code/03_panel_building/00_spine.R).
...
# program_code -> group (matches the prog_* flags built downstream in code/03_panel_building/00_spine.R)
GROUPS <- list(
