# =========================================================================================================
# code/02_cleaning/wayback/18_wayback_facility_spells.R -- collapse the facility x year wayback status series into a
...
st <- read_csv(here::here("data/processed/wayback_facility_status.csv.gz"),
...
write_csv(spells, here::here("data/processed/wayback_facility_spells.csv.gz"))
