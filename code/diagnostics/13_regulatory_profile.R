...
# =========================================================================================================
PAL <- c(blue = "#2a78d6", aqua = "#1baf7a", yellow = "#eda100", green = "#008300", violet = "#4a3aa7")
...
cat(sprintf("\n3 figures written to %s: reg_coverage_over_time.png, reg_activity_over_time.png, reg_inspections_distribution.png\n", OUT_FIG))
