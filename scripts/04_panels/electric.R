# =========================================================================================================
# scripts/04_panels/electric.R -- sample panel: electric utilities (contiguous US) x year, with the full
#   regulatory-activity detail (inspection / violation / enforcement / cert / stack-test breakdowns),
...
cat(sprintf("electric panel: %d rows | %d facilities | %d cols | %d ever in a PM2.5 NAA\n",
            nrow(panel), n_distinct(panel$PGM_SYS_ID), ncol(panel),
