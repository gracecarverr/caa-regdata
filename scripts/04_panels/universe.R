...
#   full regulatory-activity detail (inspection / violation / enforcement / cert / stack-test breakdowns),
#   interval-based HPV status, formal penalties, and the facility spine attached.
#   in : data/panels/spine.csv.gz  +  data/clean/{inspections,violations,formal_actions,informal_actions,certs,stacktests}.csv.gz
#   out: data/panels/universe.csv.gz   (93 columns: 77 detail + obs_source + 5 spell + 10 year-varying wayback status)
...
cat(sprintf("universe panel: %d rows | %d facilities | %d cols | %d-%d\n",
