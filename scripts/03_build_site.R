# =========================================================================================================
# scripts/03_build_site.R — assemble docs/index.html from the per-source table scripts in scripts/tables/.
#   Each scripts/tables/<asset>.R defines build_<asset>_section() returning one <section> of HTML, built
#   from data/raw with the same computations + curated content as the old CAA_Project *_table.xlsx
#   workbooks. This script sources them (in display order), concatenates the sections, and writes the page.
#   GitHub Pages serves docs/index.html directly; no build tool needed.
# =========================================================================================================
library(here)
SRC <- here("scripts", "tables")
...
html <- paste0("<!doctype html><html lang='en'><head><meta charset='utf-8'>",
  ...
  "<nav>", toc, "</nav>", body,
  "<p style='text-align:center;color:#8a8f98;margin-top:3rem;font-size:.85em'>Generated by <code>scripts/03_build_site.R</code> from <code>data/raw/</code>.</p>",
  "</body></html>")
