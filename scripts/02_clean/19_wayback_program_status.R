# =========================================================================================================
# scripts/02_clean/19_wayback_program_status.R -- HISTORICAL program status from the ICIS-AIR WAYBACK
...
#   out: data/clean/wayback_program_status.csv.gz
...
# program_code -> group (matches the prog_* flags built in scripts/04_panels/00_spine.R)
GROUPS <- list(
...
write_csv(prog, here::here("data/clean/wayback_program_status.csv.gz"))
